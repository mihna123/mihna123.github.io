...
[piskelapp.com](https://www.piskelapp.com){:target="_blank"}
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-pen.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-line.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-square.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-bucket.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-remove.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
...
<p align="center">
    <img style="text: centered" src="{{"/images/pixelator-frames.gif" | prepend: site.url}}" width="450" alt="Pixelator pen showcase"/>
</p>
